  ...
  triko: [
    {
      ...
      description:
        'Felicidades, has completado exitosamente tu proceso de registro, a partir de ahora podrás aparecer en resultados de búsqueda cuando los clientes soliciten un servicio',
      author: {
        user: {
          photo_url:
